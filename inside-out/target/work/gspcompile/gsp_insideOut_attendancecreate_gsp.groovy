...
class gsp_insideOut_attendancecreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',25,['bean':(attendanceInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(attendanceInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',35,['url':([resource:attendanceInstance, action:'save'])],2)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1414323835522L
